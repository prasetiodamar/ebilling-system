...
{
    Schema::create('ftth_odp', function (Blueprint $table) {
        $table->id();
        $table->foreignId('odc_id')->constrained('ftth_odc')->onDelete('restrict');
        $table->string('nama_odp', 100);
        $table->string('odc_port', 50)->nullable();
        ...
        $table->string('jenis_odp', 50)->nullable();
