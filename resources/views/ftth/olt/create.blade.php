...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('ftth.olt.store') }}" method="POST">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_olt" class="form-control @error('nama_olt') is-invalid @enderror"
                                   value="{{ old('nama_olt') }}" placeholder="Contoh: OLT-01" required>
                            @error('nama_olt')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="ip_address" class="form-control @error('ip_address') is-invalid @enderror"
                                   value="{{ old('ip_address') }}" placeholder="Contoh: 192.168.1.1">
                            @error('ip_address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="longitude" class="form-control @error('longitude') is-invalid @enderror"
                                   value="{{ old('longitude') }}" placeholder="Contoh: 106.816666">
                            @error('longitude')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="merk" class="form-control @error('merk') is-invalid @enderror"
                                   value="{{ old('merk') }}" placeholder="Contoh: Huawei">
                            @error('merk')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="model" class="form-control @error('model') is-invalid @enderror"
                                   value="{{ old('model') }}" placeholder="Contoh: MA5800">
                            @error('model')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" name="jumlah_port_pon" class="form-control @error('jumlah_port_pon') is-invalid @enderror"
                                   value="{{ old('jumlah_port_pon', 0) }}" min="0" required>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" name="port_tersedia" class="form-control @error('port_tersedia') is-invalid @enderror"
                                   value="{{ old('port_tersedia', 0) }}" min="0" required>
                            @error('port_tersedia')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="snmp_community" class="form-control @error('snmp_community') is-invalid @enderror"
                                   value="{{ old('snmp_community') }}" placeholder="Contoh: public">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="snmp_version" class="form-control @error('snmp_version') is-invalid @enderror"
                                   value="{{ old('snmp_version') }}" placeholder="Contoh: v2c">
                            @error('snmp_version')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
